...
当前 `0.17.3` 属于 Bug 修复与配置调整版本，主要调整了：

- 萌萌币改为服务器默认货币，由 Vault / MMMVaultSync 默认货币通道处理
- 扩张领地超过 25 个区块后使用的自管货币保持为 `mengmeng_shell`
- 超过 25 区块后的玩家显示名保持为“萌萌贝壳”
- MMMVaultSync 额外自管货币只需要注册 `萌萌贝壳`、`梦幻流星`、`萌萌宝石`
